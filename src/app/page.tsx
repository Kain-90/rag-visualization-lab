...
import { ArrowRight, Github, SplitSquareHorizontal, Boxes, Search, MessageSquare } from "lucide-react"
        ...
        <div className="flex flex-col items-center justify-center space-y-8 text-center">
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 dark:text-gray-400 md:text-xl">
              通过实时可视化和交互式演示，深入理解 RAG (检索增强生成) 的核心工作原理
            </p>
          </div>
...
const FeatureCard = ({ feature }: { feature: typeof features[0] }) => (
  <div className="group relative overflow-hidden rounded-2xl border bg-background h-[200px] p-6 transition-all hover:shadow-lg">
    ...
    <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-3">{feature.description}</p>
  </div>
);
...
const features = [
  {
    title: "文本分块",
    description: "通过可视化方式展示文档切分过程，帮助理解如何创建语义连贯的文本块",
